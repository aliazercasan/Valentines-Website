...
<div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <h2 class="text-3xl font-bold text-center text-red-500 mb-8">Welcome Back</h2>
        ...
        <p class="mt-6 text-center text-gray-600">
            ...
            <a href="{{ route('register') }}" class="text-red-500 hover:text-red-600 font-semibold">Register</a>
        </p>
    </div>
</div>
@endsection
